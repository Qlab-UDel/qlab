#  NOV_PILOT ACCURACY FILE CLEANING
#  Violet Kozloff
#  March 11, 2018
#  This script cleans the auditory and visual files from the November pilot for accuracy analysis
#  NOTE: Does not include participant 9, who did not respond in several types
#  NOTE: Original psychopy files have been renamed to have a letter as a leading character. 
#     To change names of files in terminal:
#     for file in *.csv; do mv "$file" "m_$file"; done;
#  NOTE: m_002_auditory_3.csv has been modified to include participant ID during the test session
#  ****************************************************************************
...
setwd("/Users/jasinskagroup/Desktop/QLAB/psychopy_sl_beh-master/accuracy/nov_pilot/scripts/")
