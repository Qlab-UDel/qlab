...
```{r}
path <- "/Volumes/data-1/projects/blast/data/mri/imaging/scott_gcss_lpsa/data/langloc_fitlins/group_constrained_mask/child/6vox/"
...
childMin <- 
  read.csv("/Volumes/data/projects/blast/data/mri/imaging/scott_gcss_lpsa/data/indiv_langloc_output/child_minimum_top_10_lang_loc_data_9_28.csv", stringsAsFactors = F)
...
langloc_parcels <- 
  list.files("/Volumes/data/projects/blast/data/mri/imaging/scott_gcss_lpsa/data/langloc_fitlins/group_constrained_mask/child/6vox/seg_parcels",
            pattern = "langloc_gcp\\d+.nii.gz", full.names = T)
...
resampled_ref <- "/Volumes/data/projects/blast/data/derivatives/fitlins/analyzed/fitlins/sub-blastc019/level-run_name-run_sub-blastc019_run-1_contrast-randSpeechVRest_stat-z_statmap.nii.gz"
...
# Read in minimal of top 10% activation value
childMin <- 
  read.csv("/Volumes/data/projects/blast/data/mri/imaging/scott_gcss_lpsa/data/indiv_langloc_output/adult_minimum_top_10_lang_loc_data_9_29.csv", stringsAsFactors = F)
# List langloc individual intact > degraded z-maps 
aliceFile <-
  list.files("/Volumes/data/projects/blast/data/derivatives/fitlins/analyzed/fitlins_alice", 
...
# List all parcels in langloc group-constrained mask
langloc_parcels <- 
  list.files("/Volumes/data/projects/blast/data/mri/imaging/scott_gcss_lpsa/data/langloc_fitlins/group_constrained_mask/adult/6vox/seg_parcels",
            pattern = "langloc_gcp\\d+.nii.gz", full.names = T)
...
resampled_ref <- "/Volumes/data/projects/blast/data/derivatives/fitlins/analyzed/fitlins/sub-blasta010/level-run_name-run_sub-blasta010_run-1_contrast-randSpeechVRest_stat-z_statmap.nii.gz"
...
# Read in minimal of top 10% activation value
childMin <- 
  read.csv("/Volumes/data/projects/blast/data/mri/imaging/scott_gcss_lpsa/data/asl_attention/child_dan_minimum_top_10_data_10_3.csv", 
           stringsAsFactors = F)
...
# Read in minimal of top 10% activation value
childMin <- 
  read.csv("/Volumes/data/projects/blast/data/mri/imaging/scott_gcss_lpsa/data/asl_attention/adult_dan_minimum_top_10_data_10_3.csv", 
           stringsAsFactors = F)
# List ASL individual random > rest z-maps 
aslRandFile <-
  list.files("/Volumes/data/projects/blast/data/derivatives/fitlins/analyzed/fitlins", 
