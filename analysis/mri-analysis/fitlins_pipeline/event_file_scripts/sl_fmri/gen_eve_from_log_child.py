...
curr_dir = os.path.realpath("/Volumes/data/projects/blast/data/mri/in_scanner_behavioral/sl_raw_data/child/log_files")
group_name = 'blast_c'
...
data_path = '/Volumes/data/projects/blast/data/mri/in_scanner_behavioral/sl_raw_data/child/log_files/'
out_path = '/Volumes/data/projects/blast/data/derivatives/event_files/children_new/'
