...
# NOTE: f002_auditory_6 has been modified to contain the correct partID.
# NOTE: All f002_auditory files have been modified to have an ltarget of a type that can be read
#  ****************************************************************************
