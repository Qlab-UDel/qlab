...
### Specific Pairwise correlations (need to check these!)
```{r}
...
r<-rcorr(df_corr$Global_long,df_corr$scaled_rt_slope,type = "spearman")
r<-rcorr(df_corr$Global_short,df_corr$scaled_rt_slope,type = "spearman")
r<-rcorr(df_corr$Local_high,df_corr$scaled_rt_slope,type = "spearman")
r<-rcorr(df_corr$Local_low,df_corr$scaled_rt_slope,type = "spearman")
...
t.test(scaled_rt_slope~learner2,data = df_corr)
t.test(accuracy~learner2,data = df_corr)
