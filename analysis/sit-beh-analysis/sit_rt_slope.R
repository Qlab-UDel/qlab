...
#  NOTE: Excludes any trials where participant did not respond
...
t.test(sll$rt_slope,mu=0) # n.s. p-value = 0.09049
t.test(slv$rt_slope,mu=0) # n.s. p-value = 0.08473
t.test(svl$rt_slope,mu=0) # p-value = 0.01515
t.test(svv$rt_slope,mu=0) # marginal p-value = 0.06411


# TO DO: ANOVA (for RT, slope, and accuracy)
