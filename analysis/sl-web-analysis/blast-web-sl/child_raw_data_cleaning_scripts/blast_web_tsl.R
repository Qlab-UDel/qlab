...
tsl_entropy_key <-
  read.csv("/Volumes/data/projects/blast/data/online_sl/entropy_keys/tsl_entropy_key.csv")
tsl_entropy_key <-
...
# Read in the entropy key
tsl_entropy_key_bal <-
  read.csv("/Volumes/data/projects/blast/data/online_sl/balanced2afc_entropy_keys/tsl_bal_entropy.csv")
tsl_entropy_key_bal <-
