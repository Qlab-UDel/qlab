...
write.csv(lsl_entropy_by_triplet[,5:6], paste0(output_path, "online_lsl_randomized_entropy_adults.csv"))
...
write.csv(lsl_acc_table, paste0(output_path, "online_lsl_random_2afc_accuracies.csv"))
