...
input_path <- "/Volumes/data/projects/blast/data_summaries/blast_online_adult_lsl_clean/predictable_lsl/"
input_path2 <- "/Volumes/data/projects/blast/data_summaries/blast_online_adult_lsl_clean/"
...
# All the wrong key presses time should have been removed from the blast_web_lsl_cleaning.R script. You should see 0 rows in the print command here.
...
indiv_rts <- as.data.frame(indiv_rts)

indiv_rts$par_id <- gsub("_lsl", "", indiv_rts$par_id)
