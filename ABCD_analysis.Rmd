...
fam_block <- vsl[which(vsl$trial_index<=300 & vsl$trial_index>=13),] #the familiarization block starts with index number 13 and ends with index 300
fam_trial <- rt_df1[which(rt_df1$trial<=300 & rt_df1$trial>=13), ]
