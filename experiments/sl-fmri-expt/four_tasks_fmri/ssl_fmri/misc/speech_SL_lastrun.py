...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.83.04), Wed Apr 26 08:02:48 2017
...
expName = 'speech_SL'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/wendygeorgan/Desktop/speech_SL_040217/speech_SL.psyexp',
...
target_syllable_sound = sound.Sound('du.wav', secs=-1)
...
target_practice_text = visual.TextStim(win=win, ori=0, name='target_practice_text',
    ...
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0)
target_practice_sound = sound.Sound('du.wav', secs=-1)
...
fam_trials_loop = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('speech_soundFileList2.xlsx'),
...
test_trials = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'speech_forced_test_1.xlsx'),
