...
expName = 'vv'  # from the Builder filename that created this script
...
vtarget2 = ['Alien3','Alien20','Alien17','Alien11']
vtarget1 = ['Alien6','Alien13','Alien9','Alien22']
random.shuffle(vtarget1)
random.shuffle(vtarget2)

firstTarg = vtarget1[1]
secondTarg = vtarget2[1]
...
blockList= ['sv_1','sv_2','sv_3','sv_4','sv_5','sv_6','rv_1','rv_2','rv_3','rv_4','rv_5','rv_6']
