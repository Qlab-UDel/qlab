...
expName = 'lv'  # from the Builder filename that created this script
...
vtarget = ['Alien3','Alien20','Alien17','Alien11']
ltarget = ['B','F','U','R']
random.shuffle(vtarget)
random.shuffle(ltarget)

firstTarg = ltarget[1]
secondTarg = vtarget[1]
...
blockList= ['sl_1','sl_2','sl_3','sl_4','sl_5','sl_6','rv_1','rv_2','rv_3','rv_4','rv_5','rv_6']
