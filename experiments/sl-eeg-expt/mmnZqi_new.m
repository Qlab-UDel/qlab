...
% Auditory Mismatch Experiment at QLAB
% Zhenghan Qi November 14, 2017
...
% try
%  p.di = DaqDeviceIndex;
%  DaqDConfigPort(p.di,0,0); % DaqDConfigPort probably is not the right function, because we
%  use parallel port.
