...
run_locally <-
  function(path,
    ...
    pr$handle("POST", "/submit", function(req, res) {
      ...
      readr::write_csv(dat, file.path(data_folder, paste0(part_id, "_vsl", ".csv")))
    })
...
run_locally(
  # Change the path to your local/xslR folder. Please include "". (e.g. "/Users/username/Downloads/local/vslR")
