  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div style=""><p>Please click on the button bellow to continue when you are ready. If this is your second time seeing this screen, you have completed the experiment.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Launch Experiment</button></div>');
