...
expInfo = {u'language': u'', u'target': u'', u'PartID': u''}
...
# set up handler to look after randomisation of conditions etc
trials_1 = data.TrialHandler(nReps=0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'soundFileList%s.xlsx' % str(expInfo['language'])),
...
twoAFC_1 = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'twoAFC_%s.xlsx' % str(expInfo['language'])),
